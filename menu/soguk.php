...
<div class="container-fluid" style="width: %65" >
    ...
    <ul class="menu">
        ...
        <li><a class="active" href="soguk.php">Soğuk Kahveler</a></li>
    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 g-4">
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/affogato.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Affogato</h5>
                    <p class="card-text">Sıcacık espressonun içine kaymaklı dondurmamızdan koyup üzerinde taze kremayla servis ediyoruz.</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/coldbrew.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Cold Brew</h5>
                    <p class="card-text">Sıcak suyla yumuşatılmış espressodan yapılan Americano! Yumuşak içimli kahve sevenler için doğru seçim</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/Iced-Americano.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Buzlu Americano</h5>
        ...
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/Cikolata-Frappe.jpg" class="card-img-top" alt="...">
                <div class="card-body">
