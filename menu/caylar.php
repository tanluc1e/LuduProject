...
<div class="container-fluid" style="width: %65" >
    ...
    <ul class="menu">
        ...
        <li><a class="active" href="caylar.php">Çaylar</a></li>
    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 g-4">
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/cay.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Siyah Çay</h5>
                    <p class="card-text"></p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/nanecayi.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Nane Çayı</h5>
                    <p class="card-text"></p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/ihlamur.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Ihlamur Çayı</h5>
                    <p class="card-text"></p>
                </div>
            </div>
        </div>
