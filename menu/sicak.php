...
<div class="container-fluid" style="width: %65" >
    ...
    <ul class="menu">
        ...
        <li><a class="active" href="#index">Sıcak Kahveler</a></li>
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 g-4">
            <div class="col">
                <div class="card text-white bg-dark h-100">
                    <img src="../images/menu/sicakicecekler/turk-kahvesi.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Türk Kahvesi</h5>
                        <p class="card-text">Çok kavrulmuş kahve çekirdeğinden elde ettiğimiz mis kokulu kahvemizi,
                            geleneksel pişirme kültürüne sadık kalarak cezve ile pişiriyor, çikolata ve su ile ikram
                            ediyoruz.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card text-white bg-dark h-100">
                    <img src="../images/menu/sicakicecekler/americano.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Americano</h5>
                        <p class="card-text">Sıcak suyla yumuşatılmış espressodan yapılan Americano! Yumuşak içimli
                            kahve sevenler için doğru seçim</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card text-white bg-dark h-100">
                    <img src="../images/menu/sicakicecekler/espresso.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Espresso</h5>
                        <p class="card-text">Keskin kokusu ve yoğun tadıyla, kahve severlerin vazgeçemediği tat.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card text-white bg-dark h-100">
                    <img src="../images/menu/sicakicecekler/macchiato.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Macchiato</h5>
                        <p class="card-text">Üzerinde taptaze süt köpüğüyle servis edilen bir espresso ziyafeti...</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card text-white bg-dark h-100">
                    <img src="../images/menu/sicakicecekler/mocha.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Mocha</h5>
                        <p class="card-text">Espresso, süt ve çikolatanın birleşiminden ortaya çıkan sıcacık bir kahve!
                            Yumuşak içimli kahvemizi çok beğeneceksiniz.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card text-white bg-dark h-100">
                    <img src="../images/menu/sicakicecekler/filtre-kahve.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Filtre Kahve</h5>
                        <p class="card-text">Özel harmanladığımız filtre kahvemiz yüksek kıvamlı, dengeli bir aromaya
                            sahiptir. %100 Arabica harmanıdır.</p>
                    </div>
                </div>
            </div>
        </div>
