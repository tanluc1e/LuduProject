...
<div class="container-fluid" style="width: %65">
    ...
    <ul class="menu">
        ...
        <li><a href="cooler-smoothies.php">Cooler & Smoothies</a></li>

        <li><a class="active" href="atistirmaliklar.php">Atıştırmalıklar</a></li>
    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 g-4">
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/hindi-fume-sandvic.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Hindi Füme Sandviç</h5>
                    <p class="card-text">Susamlı ekmek içinde hindi füme, taze kaşar peynir, mayonez, avokado sos, domates, kıvırcık salata</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/tuzlular/tavuksezar.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Tavuk Sezar Sandviç</h5>
                    <p class="card-text">Baget ekmeği içinde sezar salata sosu ile hazırlAnmış tavuk, parmesan peynir, domates, kıvırcık salata</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/ton-balikli-sandvic.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Ton Balıklı Sandviç</h5>
                    <p class="card-text">Susamlı ekmek içinde mısır ve mayonez ile harmanlanmış Ton balığı, salatalık turşusu, Kıvırcık salata</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/tuzlular/mozarella.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Mozarellalı Sandviç</h5>
                    <p class="card-text">Baget ekmek içinde mozzarella peynir, krem parmesan peynir, pesto sos (fesleğenli), nar ekşisi, kıvırcık salata.</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/tuzlular/kruvasan.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Kruvasan</h5>
                    <p class="card-text">Sabah saatlerinin vazgeçilmezi tereyağlı kruvasanlarımızı günün her saatinde sizlere taptaze sunuyoruz.</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/karisik-simit.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Karışık Simit</h5>
                    <p class="card-text">Tahıllı simit içinde dana jambon, salam, taze kaşar peyniri, süzme beyaz peynir, burger peyniri.</p>
                </div>
            </div>
        </div>
    </div>
