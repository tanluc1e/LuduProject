...
<div class="container-fluid" style="width: %65" >
    ...
    <ul class="menu">
        ...
        <li><a class="active" href="tatlilar.php">Tatlılar</a></li>
    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 g-4">
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/mozaik-pasta.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Mozaik Pasta</h5>
                    <p class="card-text">Ev yapımı lezzetli̇ pastalarımızı si̇zi̇n için özenle üreti̇yoruz. Bu sayede lezzeti̇,tazeli̇ği ve beğeni̇ni̇zi̇ garanti̇ edi̇yoruz.</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/cheesecake.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Frambuazlı Cheesecake</h5>
                    <p class="card-text"></p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/profiterol.jpg" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/findikli-top.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Fındık Kremalı Top</h5>
                    <p class="card-text">İçi nefis fındık kreması dolgulu, dışı kıtır mı kıtır kaplamalı. Tarçın ve vanilya kokulu hamuruyla karşınızda.</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/cikolatali-sufle.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Çikolatalı Sufle</h5>
                    <p class="card-text"></p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card text-white bg-dark h-100">
                <img src="../images/menu/brownie.jpg" class="card-img-top" alt="...">
                <div class="card-body">
